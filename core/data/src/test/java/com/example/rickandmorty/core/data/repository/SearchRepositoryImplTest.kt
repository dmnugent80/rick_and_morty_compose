...
import com.example.rickandmorty.core.data.fixtures.CharacterFixtures
...
class SearchRepositoryImplTest {
    ...
    fun `getCharacterById maps DTO correctly`() = runTest {
        ...
        coEvery { characterDao.getCharacterById(42) } returns null
        coEvery { api.getCharacter(42) } returns dto
        coEvery { characterDao.insertAll(any()) } returns Unit
    ...
    fun `getCharacterById calls API with correct id`() = runTest {
        ...
        coEvery { characterDao.getCharacterById(123) } returns null
